...
public class BookingLifecycleService {
    ...
    @Transactional
    public RideRequest confirm(Long rideRequestId) {
    ...
    /** Driver declines a pending booking. */
    @Transactional
    public RideRequest reject(Long rideRequestId) {
    ...
    /** Passenger withdraws a pending or confirmed booking. */
    @Transactional
    public RideRequest cancel(Long rideRequestId) {
        RideRequest request = transition(rideRequestId, BookingStatus.CANCELLED);
     ...
     */
    @Transactional
    public int completeTrip(Long tripOfferId) {
